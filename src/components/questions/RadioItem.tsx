            ...
            {isEditable && checked && (
                <div className="mt-2 px-1">
                    <input
                        ...
                        className="w-full bg-white border border-black/10 rounded-2xl px-4 py-3 text-black text-base font-light placeholder:text-xs placeholder:tracking-normal placeholder:placeholder-black/30 focus:outline-none focus:border-black/40 transition-all"
                        autoFocus
                    />
                </div>
            )}
